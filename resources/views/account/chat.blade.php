                        ...
                        <div class="chatbox">
                            <div class="modal-dialog-scrollable">
                                <div class="modal-content">
                                        ...
                                        <div class="msg-body">
                                            <ul>
                                                @foreach ($chats as $chat)
                                                    @if ($chat_id == $chat->sender_id || $chat_id == $chat->receiver_id)
                                                        <li
                                                            class="{{ $chat->sender_id == $chat_id ? 'sender' : 'repaly' }}">
                                                            <p> {{ $chat->text }} </p>
                                    ...
                                    <div class="send-box">
                                        <form action="/account/chat/{{ $chat_id }}" method="POST">
                                            @csrf
